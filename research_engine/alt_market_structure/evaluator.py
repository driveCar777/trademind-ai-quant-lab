...
from research_engine.alt_market_structure import HOLD_BARS, AMS_BLOCK, AMS_BOOT, AMS_PERM, AMS_SEED, OCCUPANCY_FAIL
...
from research_engine.alt_market_structure.windows import same_role_hold
