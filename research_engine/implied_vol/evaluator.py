...
from research_engine.implied_vol import HOLD_BARS, IV_BLOCK, IV_BOOT, IV_PERM, IV_SEED, OCCUPANCY_FAIL
...
from research_engine.implied_vol.windows import same_role_hold
