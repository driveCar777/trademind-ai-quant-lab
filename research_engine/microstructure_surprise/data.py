"""Load locked GOLD/OIL H1 parents and tag surprise. Hash mismatch stops."""
from __future__ import print_function

import os

from research_engine.errors import ContractMismatch
from research_engine.microstructure_surprise import EXPECTED_SHA, LOGICAL, PARENTS
from research_engine.microstructure_surprise.event_detector import tag_bars
...
def load_target(market_root, dataset_id):
    ...
    if manifest.get("dataset_id") != dataset_id or manifest.get("timeframe") != "H1":
