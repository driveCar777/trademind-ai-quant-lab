"""Locked EIA production/utilization space. Worker cannot change z_cut."""
...
CANONICAL_PAYLOAD = {
    ...
    "sup_params": {"z_cut": Z_CUT, "z_lookback": Z_LOOKBACK},
    "knowledge_time_rule": "week_ending_Friday_plus_Wednesday_16:00Z_then_NEXT_BAR_OPEN",
    "not_inventory_stocks": True,
    "not_price_only": True,
...
HYPOTHESIS_SPECS = {
    "HYP-SUP-0001": {
        "hypothesis_id": "HYP-SUP-0001",
        "target_asset": "OIL",
        "event": "PROD_DROP_CROSS",
        "predicted_sign": 1,
        "hold_bars": HOLD_BARS,
        "mechanism": "US crude production WoW z-cross below -2: supply drop bids oil.",
    },
    "HYP-SUP-0002": {
        "hypothesis_id": "HYP-SUP-0002",
        "target_asset": "OIL",
        "event": "UTIL_UP_CROSS",
        "predicted_sign": 1,
        "hold_bars": HOLD_BARS,
        "mechanism": "US refinery utilization z-cross above +2: run-rate tightness bids oil.",
    },
    "HYP-SUP-0003": {
        "hypothesis_id": "HYP-SUP-0003",
        "target_asset": "GOLD",
        "event": "PROD_DROP_CROSS",
        "predicted_sign": 1,
        "hold_bars": HOLD_BARS,
        "mechanism": "Crude production drop is an energy/inflation impulse into gold.",
    },
}
...
def deny_oos():
    try:
        final_oos_access(reason="inventory_v1_contract")
...
def build_search_space():
    deny_oos()
    from research_engine.supply import LOCKED_HASH
