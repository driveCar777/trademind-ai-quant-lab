...
from research_engine.usd_metal import UM_BLOCK, UM_BOOT, UM_PERM, UM_SEED, HOLD_BARS, OCCUPANCY_FAIL
...
from research_engine.usd_metal.windows import same_role_hold
