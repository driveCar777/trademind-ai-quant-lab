"""Locked DXY-into-metals space. Worker cannot change z_cut or invent events."""
...
CANONICAL_PAYLOAD = {
    ...
    "um_params": {"z_cut": Z_CUT, "z_lookback": Z_LOOKBACK, "feature": "DXY_close_z"},
    "knowledge_time_rule": "same_or_prior_DXY_date_then_NEXT_BAR_OPEN",
...
HYPOTHESIS_SPECS = {
    "HYP-UM-0001": {
        "hypothesis_id": "HYP-UM-0001",
        "target_asset": "GOLD",
        "event": "DXY_UP_CROSS",
        "predicted_sign": -1,
        "hold_bars": HOLD_BARS,
        "mechanism": "DXY z-cross above +2: dollar impulse, gold down.",
    },
    "HYP-UM-0002": {
        "hypothesis_id": "HYP-UM-0002",
        "target_asset": "GOLD",
        "event": "DXY_DOWN_CROSS",
        "predicted_sign": 1,
        "hold_bars": HOLD_BARS,
        "mechanism": "DXY z-cross below -2: dollar fade, gold up.",
    },
    "HYP-UM-0003": {
        "hypothesis_id": "HYP-UM-0003",
        "target_asset": "SILVER",
        "event": "DXY_UP_CROSS",
        "predicted_sign": -1,
        "hold_bars": HOLD_BARS,
        "mechanism": "DXY z-cross above +2: dollar impulse, silver down.",
    },
}
...
def deny_oos():
    try:
        final_oos_access(reason="usd_metal_v1_contract")
...
def build_search_space():
    deny_oos()
    from research_engine.usd_metal import LOCKED_HASH
