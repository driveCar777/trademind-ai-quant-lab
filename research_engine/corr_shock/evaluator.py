...
from research_engine.corr_shock import HOLD_BARS, OCCUPANCY_FAIL, CS_BLOCK, CS_BOOT, CS_PERM, CS_SEED
...
from research_engine.corr_shock.windows import same_role_hold
