...
CANONICAL_PAYLOAD = {
    ...
    "knowledge_time_rule": "UST_session_date_plus_21:00Z_then_NEXT_BAR_OPEN",
    "not_price_only": True,
    "not_zcut_search": True,
    "parent_datasets": list(PARENTS),
    "rates_params": {"z_cut": Z_CUT, "z_lookback": Z_LOOKBACK},
...
HYPOTHESIS_SPECS = {
    "HYP-RATES-0001": {
        "hypothesis_id": "HYP-RATES-0001",
        "target_asset": "GOLD",
        "event": "RATE_UP_CROSS",
        "predicted_sign": -1,
        "hold_bars": HOLD_BARS,
        "mechanism": "UST 10y z-cross above +2 tightens discount rates; gold sells off.",
    },
    "HYP-RATES-0002": {
        "hypothesis_id": "HYP-RATES-0002",
        "target_asset": "GOLD",
        "event": "RATE_DOWN_CROSS",
        "predicted_sign": 1,
        "hold_bars": HOLD_BARS,
        "mechanism": "UST 10y z-cross below -2 loosens financial conditions; gold bids.",
    },
    "HYP-RATES-0003": {
        "hypothesis_id": "HYP-RATES-0003",
        "target_asset": "OIL",
        "event": "RATE_UP_CROSS",
        "predicted_sign": -1,
        "hold_bars": HOLD_BARS,
        "mechanism": "UST 10y z-cross above +2 tightens conditions; oil sells off.",
    },
}
...
def deny_oos():
    try:
        final_oos_access(reason="rates_v1_contract")
...
def build_search_space():
    deny_oos()
    from research_engine.rates import LOCKED_HASH
