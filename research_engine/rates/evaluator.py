...
from research_engine.rates import HOLD_BARS, RATES_BLOCK, RATES_BOOT, RATES_PERM, RATES_SEED, OCCUPANCY_FAIL
from research_engine.rates.contract import deny_final_oos
from research_engine.rates.event_detector import fired_at
from research_engine.rates.windows import same_role_hold
