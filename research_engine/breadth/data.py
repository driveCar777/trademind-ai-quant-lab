"""Load the locked ag + GOLD D1 book. Hash mismatch stops."""
from __future__ import print_function

import os

from research_engine.errors import ContractMismatch
from research_engine.breadth import BASKET, EXPECTED_SHA, FEATURE_BASKET, LOGICAL, PARENTS
from research_engine.breadth.features import tag_book
...
def load_parents(market_root, dataset_ids=None):
    ...
    book = tag_book(aligned, FEATURE_BASKET)
