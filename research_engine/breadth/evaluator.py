...
from research_engine.breadth import FEATURE_BASKET, HOLD_BARS, OCCUPANCY_FAIL, BR_BLOCK, BR_BOOT, BR_PERM, BR_SEED
from research_engine.breadth.contract import deny_final_oos
from research_engine.breadth.event_detector import fired_at
from research_engine.breadth.windows import same_role_hold
