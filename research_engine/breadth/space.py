"""Locked ag-breadth space. Worker cannot change lookback or invent events."""
...
CANONICAL_PAYLOAD = {
    ...
    "discovery_id": BR_ID,
    "family_id": FAMILY_ID,
    "feature_basket": list(FEATURE_BASKET),
    "fill": "NEXT_BAR_OPEN",
    "gates": {
...
HYPOTHESIS_SPECS = {
    "HYP-BR-0001": {
        "hypothesis_id": "HYP-BR-0001",
        "target_asset": "GOLD",
        "event": "BREADTH_CONTRACT",
        "side_mode": "GOLD_LONG",
        "predicted_sign": 1,
        "hold_bars": HOLD_BARS,
        "mechanism": "Ag 20d participation drops below 0.20: risk-off, long GOLD next bar.",
    },
    "HYP-BR-0002": {
        "hypothesis_id": "HYP-BR-0002",
        "target_asset": "GOLD",
        "event": "BREADTH_THRUST",
        "side_mode": "GOLD_SHORT",
        "predicted_sign": -1,
        "hold_bars": HOLD_BARS,
        "mechanism": "Ag 20d participation rises above 0.80: risk-on commodity, short GOLD next bar.",
    },
    "HYP-BR-0003": {
        "hypothesis_id": "HYP-BR-0003",
        "target_asset": "BOOK",
        "event": "BREADTH_CONTRACT",
        "side_mode": "AG_SHORT",
        "predicted_sign": -1,
        "hold_bars": HOLD_BARS,
        "mechanism": "Same contraction: short equal-weight ag complex. Not rank L3/S3.",
    },
}
...
def deny_oos():
    try:
        final_oos_access(reason="breadth_v1_contract")
...
def build_search_space():
    deny_oos()
    from research_engine.breadth import LOCKED_HASH
