"""Locked GOLD H1/D1 vol-term space. Worker cannot change lookbacks."""
...
CANONICAL_PAYLOAD = {
    ...
    "timeframe": "D1",
    "vol_params": {
        "d1_rv_lookback": D1_RV_LOOKBACK,
        "flat_pctl": FLAT_PCTL,
        "h1_rv_days": H1_RV_DAYS,
        "pct_lookback": PCT_LOOKBACK,
        "steep_pctl": STEEP_PCTL,
    },
    "windows": {
...
HYPOTHESIS_SPECS = {
    "HYP-VT-0001": {
        "hypothesis_id": "HYP-VT-0001",
        "target_asset": "BOOK",
        "event": "VOL_STEEP_CROSS",
        "side_mode": "GOLD_SHORT",
        "predicted_sign": 1,
        "hold_bars": HOLD_BARS,
        "mechanism": "H1/D1 RV ratio crosses above 252d 80th pctile: short GOLD.",
    },
    "HYP-VT-0002": {
        "hypothesis_id": "HYP-VT-0002",
        "target_asset": "BOOK",
        "event": "VOL_STEEP_CROSS",
        "side_mode": "US500_SHORT",
        "predicted_sign": 1,
        "hold_bars": HOLD_BARS,
        "mechanism": "Same steep cross: short US500. Gold vol term as risk signal.",
    },
    "HYP-VT-0003": {
        "hypothesis_id": "HYP-VT-0003",
        "target_asset": "BOOK",
        "event": "VOL_FLAT_CROSS",
        "side_mode": "GOLD_SHORT",
        "predicted_sign": 1,
        "hold_bars": HOLD_BARS,
        "mechanism": "Ratio crosses below 252d 20th pctile: short GOLD (fade compressed term).",
    },
}
...
def deny_oos():
    try:
        final_oos_access(reason="vol_term_v1_contract")
