"""TS report and decision. No hash rewrite. No 10% claim."""
...
def decide(ranking):
    ...
    return {
        ...
        "invent_tokyo_forbidden": True,
        "strategy_layer_allowed": outcome == "CANDIDATE",
        "note": "Do not retune hold or add Tokyo. Do not read Final OOS.",
    }
...
def render_markdown(ranking, decision, hashes=None):
    ...
    if hashes:
        ...
        lines.append("")
    lines.append("CAGR >= 10% is not a gate. Not weekday. Not Institutional Time.")
    lines.append("")
    return "\n".join(lines)
