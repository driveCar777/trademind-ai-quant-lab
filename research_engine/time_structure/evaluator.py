"""Hold=5 NEXT_BAR_OPEN session book. Overlap skip. No close fill. No Final OOS."""
...
from research_engine.time_structure import HOLD_BARS, OCCUPANCY_FAIL, TS_BLOCK, TS_BOOT, TS_PERM, TS_SEED
from research_engine.time_structure.contract import deny_final_oos
from research_engine.time_structure.event_detector import fired_at
from research_engine.time_structure.windows import same_role_hold
