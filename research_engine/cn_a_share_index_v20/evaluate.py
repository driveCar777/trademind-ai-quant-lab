"""V20 dual-book evaluation. MEAN_FORWARD_RETURN is not CAGR."""
...
from research_engine.cn_a_share_index_v20 import DENIED, FDR_Q, HOLD_DAYS, RESEARCH, SAME_CLUSTER_CORR, VALIDATION
from research_engine.cn_a_share_index_v20.books import capital_book_set, overlapping_predictive_set
from research_engine.cn_a_share_index_v20.paths import EQUITY, OUT, TRADES
...
def run_one(pack, elig, xok, ew, cache, hyp):
    ...
    print("V20", hid, "CAPITAL", flush=True)
            ...
            failures.append(
                {
                    ...
                    "reopen": "New contract only. Do not retune. Do not flip sign.",
                }
            )
...
def decide(candidates, ran):
    ...
    if independent:
        ...
        overall, nxt, stop = "A_SHARE_INDEX_MEMBERSHIP_V1_NO_CANDIDATE", "INDEX_MEMBERSHIP_NO_CANDIDATE", "STOP_B_FAMILY"
    else:
