"""Locked EIA inventory space. Worker cannot change z_cut."""
...
CANONICAL_PAYLOAD = {
    ...
    "inv_params": {"z_cut": Z_CUT, "z_lookback": Z_LOOKBACK},
...
HYPOTHESIS_SPECS = {
    "HYP-INV-0001": {
        "hypothesis_id": "HYP-INV-0001",
        "target_asset": "OIL",
        "event": "INV_DRAW_CROSS",
        "predicted_sign": 1,
        "hold_bars": HOLD_BARS,
        "mechanism": "US crude stocks WoW z-cross below -2: inventory draw shock bids oil.",
    },
    "HYP-INV-0002": {
        "hypothesis_id": "HYP-INV-0002",
        "target_asset": "OIL",
        "event": "INV_BUILD_CROSS",
        "predicted_sign": -1,
        "hold_bars": HOLD_BARS,
        "mechanism": "US crude stocks WoW z-cross above +2: inventory build shock weighs on oil.",
    },
    "HYP-INV-0003": {
        "hypothesis_id": "HYP-INV-0003",
        "target_asset": "GOLD",
        "event": "INV_DRAW_CROSS",
        "predicted_sign": 1,
        "hold_bars": HOLD_BARS,
        "mechanism": "Crude draw shock is an energy/inflation impulse into gold.",
    },
}
...
def build_search_space():
    deny_oos()
    from research_engine.inventory import LOCKED_HASH
