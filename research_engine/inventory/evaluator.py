...
from research_engine.inventory import HOLD_BARS, INV_BLOCK, INV_BOOT, INV_PERM, INV_SEED, OCCUPANCY_FAIL
...
from research_engine.inventory.windows import same_role_hold
