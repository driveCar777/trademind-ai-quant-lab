"""Windows-owned TERM_STRUCTURE jobs. Worker cannot add IDs."""
...
PARTITION = {
    "Xavier-01": {"hypothesis_ids": ["HYP-TSFUT-0001"], "role": "PRIMARY"},
    "Xavier-02": {"hypothesis_ids": ["HYP-TSFUT-0002"], "role": "PRIMARY"},
    "Xavier-03": {"hypothesis_ids": ["HYP-TSFUT-0003"], "role": "PRIMARY"},
    "Xavier-04": {"hypothesis_ids": ["HYP-TSFUT-0001"], "role": "CROSS_CHECK"},
}
...
def make_job(node, spec, space):
    ...
    return {
        "job_id": "TSFUT-V1-%s-%s" % (node, ids[0]),
        "discovery_id": TS_ID,
        ...
        "note": "Worker executes this list only. Do not retune slope. Do not ship the API key.",
    }
