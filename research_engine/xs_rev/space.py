"""Locked FX cross-section space. Worker cannot change lookback or invent events."""
...
HYPOTHESIS_SPECS = {
    "HYP-XS-0001": {
        "hypothesis_id": "HYP-XS-0001",
        "target_asset": "BOOK",
        "event": "XS_REBAL",
        "side_mode": "REV",
        "predicted_sign": 1,
        "hold_bars": HOLD_BARS,
        "mechanism": "10-FX 20d rank: long 3 laggards, short 3 leaders, rebalance every 5.",
    },
    "HYP-XS-0002": {
        "hypothesis_id": "HYP-XS-0002",
        "target_asset": "BOOK",
        "event": "XS_REBAL",
        "side_mode": "LAG_LONG",
        "predicted_sign": 1,
        "hold_bars": HOLD_BARS,
        "mechanism": "Same ranks: long 3 laggards only. Cross-section without the short leg.",
    },
    "HYP-XS-0003": {
        "hypothesis_id": "HYP-XS-0003",
        "target_asset": "BOOK",
        "event": "XS_REBAL_WIDE",
        "side_mode": "REV",
        "predicted_sign": 1,
        "hold_bars": HOLD_BARS,
        "mechanism": "Reversal only when 20d-return dispersion is above its 252-day median.",
    },
}
...
def deny_oos():
    try:
        final_oos_access(reason="xs_rev_v1_contract")
...
def build_search_space():
    deny_oos()
    from research_engine.xs_rev import LOCKED_HASH
