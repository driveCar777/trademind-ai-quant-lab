...
PARTITION = {
    "Xavier-01": {"hypothesis_ids": ["HYP-CUEIA-0001"], "role": "PRIMARY"},
    "Xavier-02": {"hypothesis_ids": ["HYP-CUEIA-0002"], "role": "PRIMARY"},
    "Xavier-03": {"hypothesis_ids": ["HYP-CUEIA-0003"], "role": "PRIMARY"},
    "Xavier-04": {"hypothesis_ids": ["HYP-CUEIA-0001"], "role": "CROSS_CHECK"},
}
...
def make_job(node, spec, space):
    ...
    return {
        "job_id": "CUEIA-V1-%s-%s" % (node, ids[0]),
        ...
        "seed": CUEIA_SEED,
        "bootstrap_iterations": CUEIA_BOOT,
        "permutation_iterations": CUEIA_PERM,
        "block_length": CUEIA_BLOCK,
        "fdr_q": CUEIA_FDR_Q,
        "FINAL_OOS_ACCESS": "DENIED",
        "note": "Worker executes this list only. Do not retune inventory wow or steepening. Do not ship the API key.",
    }
