...
from research_engine.carry import CARRY_BLOCK, CARRY_BOOT, CARRY_PERM, CARRY_SEED
from research_engine.carry.contract import deny_final_oos
from research_engine.carry.evaluator import evaluate_hypothesis
from research_engine.carry.windows import oos_exists
...
def run_hypothesis(
    ...
    packed,
    seed=CARRY_SEED,
    iters_boot=CARRY_BOOT,
    iters_perm=CARRY_PERM,
