...
from research_engine.regime_interaction import HOLD_BARS, RI_BLOCK, RI_BOOT, RI_PERM, RI_SEED, OCCUPANCY_FAIL
...
from research_engine.regime_interaction.windows import same_role_hold
