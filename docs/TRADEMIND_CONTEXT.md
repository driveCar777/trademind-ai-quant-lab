...
- **V26.2 FACT 2026-09-05 22:45（用户事实：只能买主板；本金 ¥10,000；偏好 ¥10 左右）：** `V26_2_ML1_TOP10_10K_MAIN_ADDENDUM.md` 跑前冻结。N=20 在 ¥10k 下不成立（¥500/只买不到一手）；N 由 ¥10k ÷ 一手 ≈¥10 股推出 = **10**，仅主板，成本 V1 + 最低佣金 ¥5/笔（≈1.25%/期，事前写明会吃掉毛超额的一半以上）。历史读取（`TOP20_MANUAL_READ_MAIN_N10_10K.json`，不读禁用窗）：研究 +156%（CAGR 10.2%，MaxDD −43%，超额 vs EW +0.77%/20d t 2.4）；验证 **+34.5%**（CAGR 12.5%，MaxDD −15%，超额 +2.67% t 2.4，21/29）；成交 ≈10/10；现金闲置 20–25%（按手取整）。→ `ML1_TOP10_10K_MAIN_VIABLE_HISTORICAL`。N=5 诊断（`_N5_10K_DIAG`：验证 +26.4%，17/29）只记录不选。`daily.py` 默认改为 `MAIN / 10000 / 10`；2026-09-04 短名单 10 只主板 ¥1.7–7 元股、每只 ¥525–960。**¥10k 是练手与流程验证，不是财务自由**；影子账本 `LEDGER_TOP20.json` 用同参数从 2026-08-28 起记。
