...
| V30 MT5 US XS | 2026-09-05：数据集 `tm-mt5-USSHARES-D1-20260905-000001` 492 只 / 2,366,615 行 / sha256 `36ea9454…`，manifest `overwrite_frozen=false`；面板 7380 × 485；23 次 refit（2006-01-03 → 2025-10-09，训练行 22k → 374k，每次标签 ≤ refit−21）；成本 = max(60 日中位 bar 点差, 当前报价点差)/2 每边 + 0.05% 滑点/边 + swap × 日历天/365；研究 180 期 / 验证 80 期非重叠；`RESULTS.json`/`DECISION.json` 落盘；四门 0/4 → NO_CANDIDATE |
