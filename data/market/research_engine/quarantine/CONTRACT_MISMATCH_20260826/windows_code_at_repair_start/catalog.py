"""Historical draft catalog. NOT the formal HYP-0001 identity.

Formal locked family is FAM-MOMENTUM-0001 under
data/market/research_engine/ (14:11 preregistration).
FAM-PERSISTENCE-0001 is a leftover draft name used only by unit-test
builders. Formal dispatch must load locked JSON, never this catalog.
"""
