...
**V11 Capital Allocation DONE。** `NEXT_PRIMARY_RESEARCH_PATH = CHINA_A_SHARE_RESEARCH_UNIVERSE`。冻结 MT5 alpha 搜索。不买 Options / Databento / Tushare。不要重开已杀死 MT5 家族。Final OOS DENIED。
