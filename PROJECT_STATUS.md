...
| 项 | 值 |
|----|-----|
| 版本 | **V25 / V25.1 / V26 / V27 / V28 done；V29 ML1 前向管线 Smoke PASS（Stability 进行中）**（ML1 Level-1 + 复现 PASS + 策略规格 + Final OOS PASS；V27 季报层 LEVEL1_SAME_CLUSTER_AS_ML1；V22–V24 NO_CANDIDATE；Databento 余额 ≈$46） |
