...
**最后更新：** 2026-09-06 11:40（V36 `CN_INDUSTRY_TO_FUTURES_V36_NO_CANDIDATE`；组合仍 1 袖 ML1 V26.8；ATLAS 80）  
**更新人：** Cursor  
...
| 项 | 值 |
|----|-----|
| 版本 | **V36 NO_CANDIDATE（行业→期货）；V31/V35 期货层关闭；ML1 + V26.8 仍是唯一袖子；V29 前向管线 Smoke PASS** |
